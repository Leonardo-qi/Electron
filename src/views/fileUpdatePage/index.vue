...
<template>
  <div class="main_body">
    ...
    <div class="update_box">
      <el-form v-for="(item, index) in ruleFormRefArr" :model="item.fileForm" ref="ruleFormRef" :rules="item.rules" label-position="top">
        <el-row>
          <el-col :span="5">
          ...
          <el-col :span="5">
            <el-form-item label="文件路径：" prop="fileUrl">
              <el-input class="input_width" v-model="item.fileForm.fileUrl" @click="handleFocus(index)" placeholder="请选择文件路径" />
            </el-form-item>
          </el-col>
